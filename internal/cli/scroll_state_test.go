...
func TestUseLegacyViewportScrollClear(t *testing.T) {
	for _, tt := range []struct {
		...
		{name: "Ghostty", goos: "darwin", environ: []string{"TERM_PROGRAM=ghostty"}, want: true},
		{name: "Linux Ghostty", goos: "linux", environ: []string{"TERM_PROGRAM=ghostty"}},
		{name: "Windows Ghostty", goos: "windows", environ: []string{"TERM_PROGRAM=ghostty"}},
