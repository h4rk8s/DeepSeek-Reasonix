...
func TestStatusFooterSemanticPaletteAcrossThemes(t *testing.T) {
	...
	for _, tt := range []struct {
		mode, modelSGR, labelSGR, valueSGR, secondarySGR string
	}{
		{mode: "dark", modelSGR: "\033[1;38;5;179m", labelSGR: "\033[38;5;248m", valueSGR: "\033[38;5;251m", secondarySGR: "\033[38;5;245m"},
		{mode: "light", modelSGR: "\033[1;38;5;136m", labelSGR: "\033[38;5;241m", valueSGR: "\033[38;5;239m", secondarySGR: "\033[38;5;243m"},
	} {
		t.Run(tt.mode, func(t *testing.T) {
			configureCLITheme(tt.mode)
			m := newTestChatTUI()
